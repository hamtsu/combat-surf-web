...
const InfoPanel = () => {
  ...
  return (
    <div className="h-full bg-stone-800 p-4 rounded-md flex flex-col gap-3">
      ...
      <Button
        onClick={() => router.push("/")}
        className="px-3 py-2 h-fit flex mt-auto bg-stone-200 hover:bg-red-400 text-stone-800 hover:text-stone-200 text-lg font-sans font-bold transition-colors rounded-lg group"
      >
        <FaGavel size={15} className="mr-2" />
        <p className="">View rules</p>
      </Button>
      <Button
        onClick={() => router.push("/")}
        className="px-3 py-2 h-fit flex bg-stone-200 hover:bg-stone-400 text-stone-800 text-lg font-sans font-bold transition-colors rounded-lg group"
      >
