...
const StatisticPanel: FC<StatisticPanelProps> = ({ icon, name, value, theme }) => {
  ...
  return (
    <div className={`h-fit ${theme?.bgSecondary || "bg-stone-800"} shadow-lg p-2 rounded-lg flex flex-col gap-3 w-full md:w-fit`}>
      ...
      <span className={`text-2xl ${theme?.bgTertiary || "bg-stone-900"} p-1 rounded-md px-3 md:text-5xl font-mono font-bold flex gap-1 select-none`}>
