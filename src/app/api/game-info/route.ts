export async function GET() {
    try {
      const response = await fetch(`https://games.roblox.com/v1/games?universeIds=5584605705`);
      ...
      return Response.json({ activePlayers: playing, favourites: favouriteCount, visits: visitCount });
    } catch (error) {
