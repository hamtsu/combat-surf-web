    ...
    return (
      <>
        ...
        <div
          ...
          className={`overflow-y-scroll flex ${userInfo.backgroundUrl
          ...
          style={{
            ...((userInfo.backgroundUrl) ? { backgroundImage: `url(${userInfo.backgroundUrl})` } : {}),
        ...
        >
          ...
          />
            ...
            <div
              className="flex gap-4 shadow-lg rounded-md w-full pr-2 md:pr-0"
              style={{
          backgroundColor: userInfo.theme?.bgSecondary || "#292524",
              }}
            >
          ...
          <div className="flex flex-col gap-1">
            <div
              className="self-start select-none md:hidden opacity-0 animate-fade-in-third rounded-md shadow-lg p-1 px-3 flex flex-col md:mt-0 h-fit"
              style={{
                backgroundColor: userInfo.theme?.bgSecondary || "#292524",
              }}
            >
