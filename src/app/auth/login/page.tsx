  ...
  return (
    <div className="flex w-full h-full flex-col items-center justify-center gap-4 p-4 md:px-48 bg-stone-900">
      <div className="rounded-md bg-stone-800 p-4 h-fit">
        <h1 className="text-8xl font-bold text-stone-300 flex items-center gap-2">
          <FaUserLock size={80} className="text-stone-500" /> Staff Login
        </h1>
        ...
        <div className="w-full rounded-md overflow-hidden bg-stone-900 text-stone-400 mt-6">
          ...
          <div className="p-2 font-mono flex gap-2 items-center">
        ...
        <div className="flex gap-4 mt-4">
          <Button
            className="bg-stone-900 py-2 px-3 flex gap-3 font-bold text-xl text-stone-300 hover:bg-red-500 group"
            onClick={login}
          >
